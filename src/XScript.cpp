...
void XScript::bindNode(XNode* node)
{
	luabridge::getGlobalNamespace(mState)
		...
		.addProperty("id", &XNode::getId, &XNode::setId)
		...
		.addFunction("getCurrentState", &XNode::getCurrentState)
		.addFunction("playSound", &XNode::playSound)
		.addFunction("delay", &XNode::luaDelay)
		.addFunction("resetTimer", &XNode::resetTimer)
		.addFunction("setTimeout", &XNode::setTimeout)
		.addFunction("enableTimer", &XNode::enableTimer)
		.addFunction("disableTimer", &XNode::disableTimer)
		// rect
		...
		.endClass()
		.deriveClass <XImage, XRect>("XImage")
		.endClass()
